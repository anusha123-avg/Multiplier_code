// =============================================================================
// booth_radix2_wrapper.v - characterization wrapper for booth_radix2_multiplier.
// See schoolbook_wrapper.v for the full explanation of why this exists.
// Requires: this file + booth_radix2_multiplier.v (design sources) +
// characterization.xdc (constraint). Set as synthesis/implementation top.
// =============================================================================

module booth_radix2_wrapper #(
    parameter WIDTH = 8
) (
    input                     clk,
